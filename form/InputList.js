...
function(declare, lang, array, on, domClass, _Widget, _Container, _TemplatedMixin, _WidgetsInTemplateMixin,
    ...
    var _InputItem = declare("common.form.InputListItem", [ _Widget, _Container, _TemplatedMixin ], {
    ...
    return declare("common.form.InputList", [ _Widget, _Container, _TemplatedMixin,
                                               _FormValueWidget ], {
